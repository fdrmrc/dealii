...
#  endif
   ...
   *
   * This preconditioner does support parallel distributed computations.
   *
   * @ingroup PETScWrappers
   */
  ...
  public:
    ...
    enum class Type
    {
       ...
       * are dropped during the prolongation. This is the default in PETSc and
       * usually converges faster than the other variants.
       */
      restrict,
      /**
